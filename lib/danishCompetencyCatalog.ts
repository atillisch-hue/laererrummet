...
export type DanishCompetencySkill={id:string;title:string;description:string;minGrade:number;status:DanishCompetencyStatus;href?:string};
export type DanishCompetencyArea={id:DanishCompetencyAreaId;title:string;shortTitle:string;description:string;icon:string;skills:DanishCompetencySkill[]};

export const danishCompetencyAreas:DanishCompetencyArea[]=[
 {id:"reading",title:"Læsning",shortTitle:"Læs",icon:"▤",description:"Forstå, finde, vurdere og bruge information i forskellige slags tekster.",skills:[
 ...
 {id:"interpretation",title:"Fortolkning & analyse",shortTitle:"Fortolk",icon:"◇",description:"Gå fra tekstnære iagttagelser til analyse, fortolkning og perspektivering.",skills:[
 ...
 {id:"writing",title:"Fremstilling",shortTitle:"Skriv",icon:"✎",description:"Planlægge, skrive, bearbejde og udgive tekster til et tydeligt formål og en modtager.",skills:[
 ...
 {id:"communication",title:"Kommunikation",shortTitle:"Formidl",icon:"◎",description:"Lytte, tale, præsentere og vælge form og medie efter situation og modtager.",skills:[
  {id:"oral",title:"Mundtlig formidling",description:"Planlægge og gennemføre en tydelig mundtlig fremstilling.",minGrade:2,status:"live",href:"/danish"},
  {id:"dialogue",title:"Samtale og respons",description:"Lytte, bygge videre, stille spørgsmål og give brugbar respons.",minGrade:2,status:"live",href:"/danish"},
  {id:"presentation",title:"Præsentation",description:"Strukturere stof, bruge eksempler og støtte publikums forståelse.",minGrade:4,status:"live",href:"/danish"},
  ...
  {id:"rhetoric",title:"Retorik og appel",description:"Vurdere og bruge argumentation, appelformer og sproglige virkemidler.",minGrade:7,status:"live",href:"/danish"}
 ]},
 {id:"language",title:"Sprog & grammatik",shortTitle:"Sprog",icon:"Aa",description:"Forstå og bruge sprogets system, retskrivning og sproglige virkemidler.",skills:[
 ...
 {id:"exam",title:"Prøveforberedelse",shortTitle:"Prøver",icon:"✓",description:"Træne prøveformer og strategier på et niveau, der passer til eleven.",skills:[
...
export function danishGradeBand(grade:number|null|undefined){if(grade==null)return"Åben progression";if(grade<=2)return"1.–2. klasse";if(grade<=4)return"3.–4. klasse";if(grade<=6)return"5.–6. klasse";if(grade<=9)return"7.–9. klasse";return"10. klasse"}
export function danishSkillsForGrade(area:DanishCompetencyArea,grade:number|null|undefined){if(grade==null)return area.skills;return area.skills.filter(skill=>skill.minGrade<=grade)}
