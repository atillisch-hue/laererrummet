create or replace function private.class_math_learning_profile(p_class_id bigint)
returns jsonb
language plpgsql
stable
security definer
...
revoke all on function private.class_math_learning_profile(bigint) from public,anon;
grant execute on function private.class_math_learning_profile(bigint) to authenticated,service_role;
...
set search_path=''
as $function$
  select private.class_math_learning_profile(p_class_id)
$function$;
