...
export default function DashboardNav(){
 ...
 const visibleItems=teachingAccess?teachingItems:employeeAccess?employeeItems:[];
 const homeHref=teachingAccess?"/noticeboard":employeeAccess?"/teacher-room":parent?"/parent":board?"/board":"/";
 const roleLabel=starts(pathname,"/admin")?"Admin":starts(pathname,"/parent")?"Forælder":starts(pathname,"/board")?"Bestyrelse":teacher?"Lærer":leader?"Ledelse":staff?"Medarbejder":admin?"Admin":"Bruger";
