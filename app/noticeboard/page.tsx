...
export default function Noticeboard(){
 ...
 const remove=async(id:string)=>{await supabase.from("noticeboard_posts").delete().eq("id",id);await loadNotes()};
