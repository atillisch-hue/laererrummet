...
export default function TeacherRoom(){
 ...
 return <main style={{minHeight:"100vh",background:"#f5f3ee"}}>
  ...
  <section style={{maxWidth:1120,margin:"0 auto",padding:"50px 28px 90px"}}><p className="eyebrow">LÆRERNES ARBEJDSRUM</p><h1 style={{maxWidth:720,marginBottom:10}}>Det vi løser sammen</h1><p style={{fontSize:18,color:"#6f746f",maxWidth:760,lineHeight:1.6,marginTop:0}}>Lærerværelset samler medarbejdernes fælles arbejde. Kalenderen har sin egen hovedindgang, mens elev- og undervisningsarbejdet hører hjemme i Klasseværelset og Forberedelsen.</p>
