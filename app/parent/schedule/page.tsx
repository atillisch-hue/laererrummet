...
import {isoWeek,recurrenceLabel,scheduleOccursOn,type RecurrencePattern} from "../../../lib/scheduleRecurrence";
...
type Child={id:number;name:string;class_name:string|null;schedule:ScheduleEntry[];closed_days:ClosedDay[]};
...
export default function ParentSchedulePage(){
 ...
 return <main style={{minHeight:"100vh",background:"#f5f3ee",color:"#26342e"}}><section style={shell}>
  ...
  <p style={{maxWidth:720,color:"#687068",fontSize:17,lineHeight:1.55}}>Her ser du klassens faktiske uge: 14-dages-rytme og skolens lukkedage er regnet med.</p>
