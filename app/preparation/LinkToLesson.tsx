...
export default function LinkToLesson(){
 ...
 return <section style={{marginTop:18,background:"#eef2ed",border:"1px solid #d4ddd6",borderRadius:14,padding:20}}>
  ...
  {lessons.length===0?<div style={{padding:"12px 14px",background:"white",borderRadius:9,color:"#687068"}}>Jeg kan ikke finde kommende skemalagte lektioner på din bruger endnu.</div>:<div style={{display:"grid",gap:13}}>
