...
type Result={student_id:number;student_name:string;completed:boolean;score:number|null;max_score:number|null;completed_at:string|null;answers?:Record<string,string|AnswerDetail>|null;attempts?:number;best_score?:number|null;best_max_score?:number|null;mastered?:boolean};
