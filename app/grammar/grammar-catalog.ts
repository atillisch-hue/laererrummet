...
export const grammarAreas: GrammarArea[] = [
  {
    ...
    topics: [
      ...
      { title: "Forholdsord", minGrade: 4, live: true },
      { title: "Bindeord", minGrade: 4, live: true },
      { title: "Kendeord", minGrade: 3, live: true },
      { title: "Talord", minGrade: 3, live: true },
      { title: "Udråbsord", minGrade: 3, live: true },
    ],
  },
  {
    icon: "↺",
    ...
    topics: [
      ...
      { title: "Navneords bøjning", minGrade: 3, live: true },
      { title: "Tillægsords bøjning", minGrade: 4, live: true },
      { title: "Udsagnsords tider", minGrade: 5, live: true },
      { title: "Aktiv og passiv", minGrade: 7, live: true },
      { title: "Modalverber", minGrade: 7, live: true },
    ],
  },
  {
    icon: "S",
    ...
    topics: [
      ...
      { title: "Hensynsled", minGrade: 6, live: true },
      { title: "Adverbialled", minGrade: 6, live: true },
      { title: "Ordstilling og inversion", minGrade: 6, live: true },
      { title: "Sætningsskema", minGrade: 7, live: true },
    ],
  },
  {
    icon: "✓",
  ...
  },
  {
    ...
    topics: [
      ...
      { title: "Sammenhæng og forbindelsesord", minGrade: 5, live: true },
      { title: "Reference og henvisninger", minGrade: 5, live: true },
      { title: "Korrektur i egne tekster", minGrade: 5, live: true },
    ],
  },
  {
    icon: "M",
    ...
    topics: [
      { title: "Ordfamilier", minGrade: 4, live: true },
      { title: "Rodmorfemer", minGrade: 6, live: true },
      { title: "Bøjningsmorfemer", minGrade: 6, live: true },
      { title: "Afledningsmorfemer", minGrade: 7, live: true },
      { title: "Forstavelser og endelser", minGrade: 5, live: true },
      { title: "Nominalisering", minGrade: 7, live: true },
    ],
  },
];
