  ...
  useEffect(()=>{
    ...
    const enhance=()=>{
      ...
      if(writing&&!document.getElementById("manual-save-wrap")){
        ...
        wrap.style.cssText="display:flex;align-items:center;gap:12px;justify-content:space-between;margin-top:18px;flex-wrap:wrap";
        const progress=document.createElement("span");
        progress.id="student-writing-progress";
        progress.style.cssText="font-size:14px;color:#657068;font-weight:700";
        ...
        status.style.cssText="font-size:14px;color:#55705d;font-weight:700";
        ...
        button.onclick=()=>{
          ...
          status.textContent="Gemt ✓";button.textContent="Gemt ✓";button.style.opacity=".82";setSaved(true);
          window.setTimeout(()=>{button.textContent="Gem opgave";button.style.opacity="1";status.textContent="Alt er gemt ✓";setSaved(false)},1800);
        };
        ...
        actions.append(status,button);wrap.append(progress,actions);writing.appendChild(wrap);updateProgress();
      }
      ...
      if(teacherHeader&&!document.getElementById("teacher-overview-link")){
        ...
        link.id="teacher-overview-link";link.href="/teacher-overview";link.textContent="Opgaver & besvarelser →";
