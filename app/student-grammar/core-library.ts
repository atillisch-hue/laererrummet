...
export const coreGrammarLibrary: GrammarBank = mergeBanks(baseCoreGrammarLibrary, structureExtraLibrary, retskrivningExtraLibrary, completeWordClassesLibrary, inflectionSyntaxLibrary, morphologyTextLibrary);
